		...
		<div class="container">
			<div class="row">
				...
				<div class="col-md-8 d-flex justify-content-end">
					<ul class="announcement-bar__list">
						<li>
							<a href=""><i class="bi bi-truck rounded-circle"></i>FREE EU SHIPPING</a>
						</li>

						<li>
							<a href=""><i class="bi bi-clock-history rounded-circle"></i>30 DAYS MONEYBACK GUARANTEE
						</li></a>

						<li>
							<a href=""><i class="bi bi-person rounded-circle"></i>24/7 CUSTOMER SUPPORT</a>
						</li>
					</ul>
				</div>
