	...
	<footer id="colophon" class="site-footer">
		...
		<div class="container pt-2 pb-2">
			<div class="row d-flex align-items-center">
				<div class="col">
					<p>&copy <?php bloginfo("name"); ?> <?php echo date(
   "Y"
 ); ?> / Created by <a  href="https://www.linkedin.com/in/trinhhuynh98/" style="color: black" target="_blank">Kayleigh</a></p>
				</div>
				<div class="col h-25 d-inline-block text-end">
					<img src="<?php echo get_template_directory_uri(); ?>/images/payment-methods.png" class="img-fluid" loading="lazy" alt="">
				</div>
			</div>
		</div>
